...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get passwordTipMessage => 'The backup password is used to encrypt backup files. Multiple devices must use the same password to share backups.';

  @override
  String get httpsWarning => 'HTTPS connection is recommended. Credentials are sent in plaintext over HTTP.';
  ...
  @override
  String get validationBackupPasswordRequired => 'Backup password cannot be empty';

  @override
  String get validationBackupPasswordMinLength => 'Backup password must be at least 8 characters';

  @override
  String get validationConfirmPasswordRequired => 'Confirm password cannot be empty';

  @override
  String get validationPasswordMismatch => 'Passwords do not match';

  @override
  String get validationHistoryCountInvalid => 'Please enter a number no less than 0';
  ...
  @override
  String get snackConfigureBackupFirst => 'Please configure complete backup parameters first';
  ...
  @override
  String get snackBiometricNotAvailable => 'Device does not support biometrics, cannot enable app lock';
  ...
  @override
  String get snackAppLockDisableFailed => 'Authentication failed, cannot disable app lock';
  ...
  @override
  String get dialogConfirmRestoreBody => 'Restoring will overwrite current data. Are you sure you want to continue?';
  ...
  @override
  String get authReasonAccess => 'Please verify your identity to access the app';

  @override
  String get authReasonEnable => 'Please verify your identity to enable app lock';

  @override
  String get authReasonDisable => 'Please verify your identity to disable app lock';
  ...
  @override
  String get importExportDescription => 'You can transfer your 2FA accounts to a new device\nCompatible with Google Authenticator migration';
  ...
  @override
  String get errorQrMissingSecret => 'QR code is missing the required secret key';

  @override
  String get errorSecretInvalidBase32 => 'Invalid key format. Must be Base32 encoded.';

  @override
  String get errorCannotRecognizeQr => 'Cannot recognize this QR code';

  @override
  String get errorTotpOnly => 'Only TOTP type is supported, HOTP is not supported in QR scan';
  ...
  @override
  String get errorCannotOpenUrl => 'Cannot open link. Please check if a browser is installed.';
  ...
  @override
  String get exceptionConfigCheckParams => 'Please check that backup parameters are complete';
  ...
  @override
  String get exceptionDownloadError => 'Error occurred while downloading backup';

  @override
  String get exceptionRestoreDataFailed => 'Failed to restore data';

  @override
  String get exceptionBackupCorrupted => 'Backup file may be corrupted or password is incorrect';
  ...
  @override
  String get exceptionNoBackupWebDav => 'No backup files found in WebDAV storage. Please run a backup first.';

  @override
  String get exceptionNoBackupS3 => 'No backup files found in S3 storage. Please run a backup first.';

  @override
  String get exceptionFormatMissingSalt => 'Backup file format error: missing salt';

  @override
  String get exceptionFormatMissingData => 'Backup file format error: missing data';

  @override
  String get exceptionDecryptFailed => 'Failed to decrypt backup data. Please verify the backup password is correct.';
